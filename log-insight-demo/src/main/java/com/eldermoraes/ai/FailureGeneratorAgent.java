...
public interface FailureGeneratorAgent {
    @SystemMessage("""
            ...
            RANDOMLY choose ONE severity level from: "CRITICAL", "ERROR", "WARN", "INFO"
            ...
            - For severity="WARN": use metric_name "system_warning_total", event_type examples: "high_memory_usage", "slow_query", "deprecated_api_call"
            ...
            - WARN: random value between 20-200 (frequent warnings)
            ...
            system_warning_total with labels component="cache",technology="redis",severity="WARN",event_type="high_memory_usage" value 145 timestamp 1732502299000
            ...
            IMPORTANT: Use uppercase severity values: CRITICAL, ERROR, WARN, INFO (not WARNING or lowercase).
